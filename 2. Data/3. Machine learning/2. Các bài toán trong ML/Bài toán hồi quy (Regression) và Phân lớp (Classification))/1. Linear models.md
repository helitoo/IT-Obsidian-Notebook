...
**Linear regression (Linear fitting, Linear least square, Hồi quy tuyến tính)** là một dạng Regression (hồi quy).

**Mục tiêu**: Tìm trọng số tối ưu của 1 hàm tuyến tính để xây dựng một hàm hoàn chỉnh, giả thiết các vector sẵn có và vector đầu vào tuân theo một *hàm tuyến tính*.
