...
Là một mô tả hình thức về những sự kiện, khái niệm.

- **Dữ liệu**: Là tập hợp các thông tin được thu thập, lưu trữ.
- **Thông tin**: Là dữ liệu đã được xử lý.
- **Tri thức**: Là những suy luận có được từ dữ liệu, thông tin và ngữ cảnh.
