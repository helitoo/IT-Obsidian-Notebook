...
# Mô hình thực thể kết hợp (Enity-Relationship diagram, ERD)

Có các thành phần sau:

| Thành phần                                  | Ý nghĩa                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | Ký hiệu                |
| ------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------- |
| **Loại thực thể<br>(Enity)**                | Một loại thực thể trên thực tế. Mỗi loại thực thể tượng trưng cho nhiều thực thể.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | Hình vuông, chữ in hoa |
| **Thuộc tính<br>(Attribute)**               | Những tính chất của loại thực thể / mối kết hợp.<br><br>Thuộc tính có 4 loại:<br><br>- **Đơn trị (Simple)**: *Chỉ có một giá trị*, không thể chia nhỏ và không thể được suy ra từ các thuộc tính khác.<br><br>- **Dẫn xuất (Derived)**: Là thuộc tính mà giá trị của nó có thể được suy ra từ các thuộc tính khác. VD: *TUOI là thuộc tính dẫn xuất vì có thể suy ra từ NAMSINH*.<br><br>- **Đa hợp / Phức hợp (Composite)**: Là thuộc tính có thể được tạo thành từ nhiều thành phần (thuộc tính con). VD: *DIACHI(SONHA, DUONG, PHUONG, THANHPHO)*.<br><br>- **Đa trị (Multi-valued)**: Là thuộc tính có nhiều giá trị khác nhau đối với cùng 1 đối tượng. VD: *{BANGCAP} (1 người có thể có nhiều bằng cấp khác nhau)*.<br><br>**Khóa (key)**: Là tổ hợp các thuộc tính mà có giá trị *khác nhau ở mỗi thực thể* dùng để xác định các đối tượng thuộc loại thực thể đó. Ký hiệu bằng cách gạch chân những thuộc tính là khóa. | Hình tròn / Ghim       |
| **Bản số<br>(Relationship cardinality)**    | Số lượng tối thiểu và số lượng tối đa các thực thể tham gia mối.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |                        |
| **Loại mối kết hợp<br>(Relationship type)** | Sự liên kết giữa hai hay nhiều loại thực thể.<br><br>**Ngôi của mối** là số lượng thực thể tham gia mối, ký hiệu là (**max1, max2**) là số lượng max của 2 thực thể tham gia mối.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | Hình thoi / Hình tròn  |
