...
**User** là một thực thể người dùng ở database, có thể thao tác lên database (đăng nhập, thêm, sửa, xóa,...).

User được sỡ hữu 1 schema, bao gồm các đối tượng như table, view, stored procedures, index, sequence,... mà user đó có quyền thao tác lên.
