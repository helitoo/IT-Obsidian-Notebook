...
| **$T$ muốn read**                   | **Kiểm tra $\boxed{TS(X)\leq TS(T)}$**.<br><br>**Đúng**: $TS(X):=TS(T)$.\|<br>**Sai**: Abort. | **Kiểm tra $\boxed{WT(X)\leq TS(T)}$**.<br><br>**Đúng**: $RT(X):=TS(T)$.<br>**Sai**: Abort.<br>                                                                                   | **Kiểm tra** liệu có tồn tại $\boxed{\text{newest}(WT_{x_i})\leq TS(T)}$.<br><br>**Đúng**: $RT(X_i):=TS(T)$.<br>**Sai**: Abort.                                                                                                           |
| **$T$ muốn write**                  | Giống kịch bản khi read.                                                                      | **Kiểm tra $\boxed{RT(X)\leq TS(T)}$**.<br><br><br>**Đúng**: Kiểm tra $\boxed{WT(X)\leq TS(T)}$.<br>**Sai**: Abort.<br><br>**Đúng**: $WT(X):=TS(T)$.<br>**Sai**: Không làm gì cả. | **Kiểm tra** liệu có tồn tại $\boxed{\text{newest}(WT_{x_i})\leq TS(T)}$.<br><br>**Đúng**: Kiểm tra $\boxed{RT(X_i)\leq TS(T)}$.<br>**Sai**: Abort.<br><br>**Đúng**: $RT(X_{i+1})=0$ và $WT(X_{i+1})=TS(T)$.<br>**Sai**: Không làm gì cả. |
