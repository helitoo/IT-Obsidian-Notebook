...
**React.js** là một framework [[1. Giới thiệu & Cài đặt JavaScript|JS]] mã nguồn mở, được phát triển và duy trì bởi Meta.
...
Tính năng nổi bậc:
- **Component-based**: Mỗi thành phần UI được xem như một component riêng, dễ sử dụng và bảo trì.
- **Virtual DOM**: Tăng hiệu suất load giao diện.
- **[[2. JSX]]**: Kết hợp giữa JS và HTML.

# Cài đặt

Sử dụng [[2. Vite]] và đặt package là `React`.
