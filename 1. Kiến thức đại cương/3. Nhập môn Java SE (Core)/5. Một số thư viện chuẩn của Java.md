...
`java.lang` là package cốt lõi của Java, được tự động [[3. OOP#Package|import]] vào chương trình Java. Package này gồm có:
- `Object`: Lớp cha của tất cả [[3. OOP#Lớp & Đối tượng|lớp]].
- `String`: [[2. Cú pháp cơ bản#Chuỗi ký tự `String`|Chuỗi ký tự]].
- [[3. OOP#Wrapper class|Wrapper class]].
