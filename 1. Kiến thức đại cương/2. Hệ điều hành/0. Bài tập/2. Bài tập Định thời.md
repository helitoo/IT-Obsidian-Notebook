...
>- **Thời gian đáp ứng (Response time)** = Thời gian waiting lần đầu tiên (*preemptive có nhiều lần waiting*).
...
>	1. Vẽ Arrival time và khoanh tròn các process đến tại arrival time đó.
>	2. Vẽ burst time.
>   Kiểm tra rằng: Tổng độ dài biểu đồ Gantt là **tổng các burst time**.
