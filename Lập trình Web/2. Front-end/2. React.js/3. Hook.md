...
`useState` là hook giúp bạn thay đổi nội dung của các component, cũng tương tự như việc lắng nghe các [[5. DOM & Event#Sự kiện|sự kiện]].
...
`useEffect` là hook giúp bạn triển khai các Side effect như lắng nghe các [[5. DOM & Event#Sự kiện|sự kiện]] hay [[9. Fetch API|gọi API]] nhằm thay đổi dữ liệu. Thường kết hợp với `useState` để thay đổi nội dung của component.
