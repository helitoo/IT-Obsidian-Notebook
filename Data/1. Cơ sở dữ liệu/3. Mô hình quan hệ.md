...
3. **Do thuộc tính tổng hợp**: $\forall x_1(...=f_{(...)}(...))$.
	- Doanh số của 1 khách hàng bằng tổng trị giác các hóa đơn của khách hàng đó.
...
2. Kiểm tra từng dạng chuẩn:
	...
	2. **3NF: Dạng chuẩn 3**: **Mọi PTH** thỏa *vế trái chứa khóa* hoặc *khóa chứa vế phải*.
	3. **2NF: Dạng chuẩn 2**: Nếu không có thuộc tính khóa nguyên tử nào mà bao hàm chứa thuộc tính không khóa thì đạt 2NF.   Xét các tập con $K_i\in K$ chỉ có 1 phần tử, nếu không có $K_{i_F}^+$ nào chứa $X_j\notin K$ (*không khóa*) thì đạt 2NF.
