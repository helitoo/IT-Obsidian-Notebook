...
Bạn có thể cài đặt Spring Boot trên [[5. Giới thiệu & Cài đặt Apache Maven#Thêm dependency|Maven remote repository]], nhưng mà kèm theo đó phải tự set up một vài công đoạn khá rườm rà. Thay vào đó, bạn có thể dùng **Spring initializr**, là một ứng dụng web cho phép cài đặt và set up các bước trung gian.
