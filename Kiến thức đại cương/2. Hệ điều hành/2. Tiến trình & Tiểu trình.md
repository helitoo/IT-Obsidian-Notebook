...
Một process có thể tạo nhiều tiến trình mới thông qua 1 [[1. Tổng quan về hệ thống máy tính và OS#Lời gọi hệ thống (System call)|system call]] *create-process*.
VD:
...
Là chuyển đổi qua lại giữa các process.
