...
>- $\boxed{\text{Need}_i=\text{Max}_i-\text{Allocation}_i}$.
...
---
Tại thời điểm $t_0$, trạng thái hệ thống như sau, và Available = \[1, 3, 1, 2]. **Process nào bị deadblock?**
...
Ta thấy toàn bộ process đang bị deadblock vì chúng đều đang yêu cầu 1 lượng resources > available.
