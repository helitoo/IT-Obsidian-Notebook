...
- **Vùng va chạm (Collision domain)**: Là vùng mạng mà tại đó, 2 nút gửi dữ liệu cùng lúc đụng độ -> Gắn liền với *giao thức truy cập ngẫu nhiên*.
...
**Cách đếm số lượng vùng va chạm**:
- 1 *switch / router/bridge / modem* kết nối với **$n$ host -> $n$ vùng va chạm**.
- Không có *switch / router/bridge / modem* -> **$1$ vùng va chạm**.
- Các thiết bị ở layer khác như *repeater, hub,... (Physical layer)*, *NIC (Physical / Link layer)*, **không** ảnh hưởng đến số lượng vùng va chạm.
