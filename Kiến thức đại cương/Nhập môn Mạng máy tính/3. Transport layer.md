...
| -------------------------------- | ------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------- |
| (Khởi tạo)                       |                     | cwnd = 1 MSS                                                                                                                                                                                                              | --                                                        |
| **Slow start**                   |                     | $$\boxed{\text{cwnd}_i=\text{cwnd}_{i-1}\times2}$$                                                                                                                                                                        | Đường cong.                                               |
| **Congestion avoidance**         | cwnd ≥ ssthread     | $$\boxed{\text{cwnd}_i=\text{cwnd}_{i-1}+1}$$                                                                                                                                                                             | Đường thẳng dốc.                                          |
| **Fast recovery**<br>(TCP Reno)  | Mất gói             | **Khi nhận được 3 ACK trùng**:<br>$$\boxed{\text{cwnd}_i=\frac{\text{cwnd}_{i-1}}{2}+3}$$Sau đó quay về *Congestion avoidance*.<br><br>---<br>**Khi timeout**:<br>$$\boxed{\text{cwnd}_i=1}$$Sau đó quay về *Slow start*. | Đường thẳng thoải.<br><br>Khi timeout sẽ giảm thẳng về 1. |
...
Lưu ý là trong sơ đồ xảy ra liên tiếp triple duplicated ACK và timeout nên ssthread ngày càng giảm. Nếu mạng ổn định thì ssthread có thể tăng.
