...
| ------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Quản lý process**                                    | [[2. Tiến trình & Tiểu trình#Khái niệm process\|Tiến trình (Process)]] là chương trình (Program) đang chạy.<br><br>Cần có:<br>- **CPU và Bộ nhớ**.<br>- Files.<br>- I/O devices... | - **Tạo** & **Hủy** process.<br><br>- **Tạm dừng** / **Thực thi tiếp** process.<br><br>- **Đồng bộ** hoạt động các process.<br><br>- **Giao tiếp** giữa các process.<br><br>- Khống chế **tắc nghẽn**.  |
