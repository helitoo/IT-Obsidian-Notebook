...
1. Phân loại kiến trúc hệ thống máy tính
2. Cấu trúc lưu trữ phân cấp (Storage hierarchy)
...
7. Các dịch vụ của OS
    1. Các dịch vụ cơ bản
    2. Lời gọi hệ thống (System call)
8. Phân loại cấu trúc OS
9. Các thao tác trong OS
...
| Đơn bộ xử lý<br>(Uniprocessor system)                                    | Đa bộ xử lý<br>(Multiprocessor system,<br>Parallel system,<br>Tightly coupled system)                                           | Gom cụm<br>(Clustered system)                                                                                                                  |
| ------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------- |
| Chỉ có **1 processor đa dụng** hoặc kèm theo *vài processor riêng biệt*. | Có nhiều processor trong hệ thống.<br><br>Có 1 processor **master** điều phối các processor khác, không thực thi mã người dùng. | Là một dạng đa bộ, nhưng gồm nhiều máy tính độc lập (node) làm việc với nhau, kết nối qua mạng.<br><br>Người dùng chỉ thao tác với 1 máy tính. |
...
|                                                                          | **Đối xứng (Symmetric Multiprocessing, SMP)**: Mọi processor cùng làm 1 việc.                                                   | **Đối xứng (Symmetric Clustering, SCP, Distributed system)**: Các node cùng chạy & giám sát lẫn nhau.                                          |
