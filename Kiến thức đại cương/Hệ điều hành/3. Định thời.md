...
| ----------------------------------------------------------------- | -------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Bộ định thời dài<br>(Long-term scheduler)**<br>(Job sheduler)   | Chọn process từ **new** sang **ready**.                  | Xảy ra **ít thường xuyên** (vì nạp job vào bộ nhớ không diễn ra liên tục).                                                                                                                                                                                                                                      |
...
| ------------------------------------------ | ------------------------------------------------- | ------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------- |
| **Không trưng dụng**<br>(*Non-preemptive*) | Không.                                            | - Khi thực thi xong.<br><br>- Khi được hệ thống I/O yêu cầu. | - Chuyển ngữ cảnh ít.<br><br>- Dễ định thời.                                                                                       | - Process chuyển từ **running sang waiting** (*đợi I/O*).                                          |
| **Trưng dụng**<br>(*Preemptive*)           | Có.                                               | - Bất kỳ lúc nào.                                            | - Thời gian đáp ứng tốt hơn *vì không có process nào độc chiếm CPU quá lâu*.<br><br>- Chi phí cao.<br><br>- Chuyển ngữ cảnh nhiều. | - Process chuyển từ **running sang ready**.<br><br>- Process chuyển từ **waiting/new sang ready**. |
