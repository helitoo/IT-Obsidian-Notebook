...
`java.lang` là package cốt lõi của Java, được tự động [[OOP cơ bản#Package|import]] vào chương trình Java. Package này gồm có:
- `Object`: Lớp cha của tất cả [[OOP cơ bản#Lớp & Đối tượng|lớp]].
- `String`: [[Các kiểu dữ liệu sơ cấp#Chuỗi ký tự `String`|Chuỗi ký tự]].
- [[OOP cơ bản#Wrapper class|Wrapper class]].
