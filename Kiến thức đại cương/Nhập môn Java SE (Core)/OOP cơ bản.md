...
Thuộc tính có thể coi là các biến của lớp, có cú pháp khai báo tương tự như [[Các kiểu dữ liệu sơ cấp#Kiểu dữ liệu|khai báo biến thông thường]].
...
Các [[Các kiểu dữ liệu sơ cấp#Các kiểu primitive|primitive type]] không phải object. Wrapper class là các lớp hỗ trợ cho các thao tác với biến primitive type như là một object.
