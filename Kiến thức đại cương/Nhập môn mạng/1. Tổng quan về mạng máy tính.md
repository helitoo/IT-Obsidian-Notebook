...
1. Tổng quan về Internet
    ...
    4. Một số thiết bị kết nối mạng
2. Các vùng mạng
...
3. Các vấn đề liên quan đến chậm trễ và mất gói
    1. Hàng đợi (Queueing)
    2. Độ trễ (Thời gian truyền gói tin)
    3. Thông lượng (Throughput, $T$)
    4. Chương trình đo độ trễ traceroute
    5. Mất gói tin
4. Phân tầng giao thức mạng
    1. Mô hình TCP/IP, OSI & Mô hình vận chuyển gói tin qua các tầng
    2. Giao thức
```
...
- **Router**: Kết nối các vùng mạng.
- **Bridge**: Kết nối các vùng mạng LAN nhỏ, ít dùng.
...
| 3   | **Network layer**                 | Datagram / Packet                            | Giữa 2 host liên tiếp                       | **Kiểm soát truy cập mạng & quản lý đường dẫn nguồn**:<br>- Định tuyến.<br>- Gán địa chỉ IP.<br>- Xử lý tắc nghẽn.                     |
| 2   | **Link layer**                    | Frame                                        | Giữa 2 nút (*Router, Switch,...*) liên tiếp | - Kiểm tra lỗi.<br>- Sửa chữa dữ liệu.<br>- Đánh địa chỉ MAC.                                                                          |
