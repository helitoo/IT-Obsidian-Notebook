...
**Một số loại cáp**:
- **Cross cable (Cáp chéo)**: Kết nối *trực tiếp* 2 thiết bị *cùng loại*.
...
| 2   | **Link layer<br>(Data link)**         | Frame                                        | Giữa 2 nút (*Router, Switch,...*) liên tiếp | - Kiểm tra lỗi và sửa lỗi.<br>- Đánh địa chỉ MAC.                                                                                      |
