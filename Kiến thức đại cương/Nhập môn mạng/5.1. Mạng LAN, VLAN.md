...
Địa chỉ MAC dài **48 bits**, là địa chỉ **độc nhất** trên toàn mạng, được **ghi thẳng vào card mạng** (NIC). Địa chỉ MAC được quản lý bởi IEEE và không gian địa chỉ MAC được mua bởi các nhà sản xuất thiết bị -> Dựa vào địa chỉ MAC có thể truy ra nhà sản xuất.
...
>[!important]
>Trong quá trình gửi gói tin qua các nút, **MAC nguồn của gói tin luôn được thay đổi là MAC của nút gửi đi**. Còn IP nguồn, IP đích, MAC đích không đổi.
