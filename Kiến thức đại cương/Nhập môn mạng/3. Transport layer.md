...
| ------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------- |
| **Nền tảng**        | [[4.1. Dịch vụ vận chuyển tại Network layer#Mạch ảo và Mạch gói tin\|Mạch ảo (Hướng kết nối)]].                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      | [[4.1. Dịch vụ vận chuyển tại Network layer#Mạch ảo và Mạch gói tin\|Mạch gói tin (Phi kết nối)]] (các gói tin được đối xử độc lập).    |
...
| Giai đoạn                        | Điều kiện kích hoạt | Ở mỗi RTT                                                                                                                                                                          |
| -------------------------------- | ------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| (Khởi tạo)                       |                     | cwnd = 1 MSS                                                                                                                                                                       |
| **Slow start**                   |                     | $$\text{cwnd}_i=\text{cwnd}_{i-1}\times2$$                                                                                                                                         |
| **Congestion avoidance**         | cwnd ≥ ssthread     | $$\text{cwnd}_i=\text{cwnd}_{i-1}+1$$                                                                                                                                              |
| **Fast recovery**<br>(TCP Reno)  | Mất gói             | **Khi nhận được 3 ACK trùng**: Quay về *Congestion avoidance*.<br>$$\text{cwnd}_i=\frac{\text{cwnd}_{i-1}}{2}+3$$<br>**Khi timeout**: Quay về *Slow start*.<br>$$\text{cwnd}_i=1$$ |
| **Fast recovery**<br>(TCP Tahoe) | Mất gói             | Quay về *Slow start*.<br>$$\text{cwnd}_i=1$$                                                                                                                                       |

>[!tip] Nhận biết các giai đoạn bằng đồ thị
>- **Slow start**: Đường cong.
>- **Congestion avoidance**: Đường thẳng dốc.
>- **Fast recovery**:
>	- *Tahoe*: Giảm thẳng về 1.
>	- *Reno*: Đường thẳng không dốc, sau đó cũng giảm thẳng về 1.
