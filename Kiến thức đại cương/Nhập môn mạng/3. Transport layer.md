...
Một số protocol tầng Ứng dụng dựa trên TCP/IP:

| Protocol                                    | Dựa trên                           | Port | Chức năng                                                         | Đặc điểm                                                                                                |
| ------------------------------------------- | ---------------------------------- | ---- | ----------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------- |
| **HTTP<br>(Hypertext transfer protocol)**   | TCP                                | 80   | Lấy dữ liệu về từ server.                                         | - Có 2 dạng là bền vững và không bền vững.<br><br>- Msg có thể ở dạng **ASCII 8-bit** (`\n`, `\r`,...). |
...
| **DNS<br>(Domain name system)**             | UDP (msg nhỏ)<br><br>TCP (msg lớn) | 53   | Gửi query để tra cứu IP và response để trả về IP.                 |                                                                                                         |
