...
1. **[[4.1. Dịch vụ vận chuyển tại Network layer#Địa chỉ IP|Địa chỉ IP]]**: Địa chỉ logic của host (*khác với MAC là địa chỉ vật lý*). Địa chỉ IP là một dãy số, có thể viết dưới một số dạng khác:
